...
func TestParsingJSON(t *testing.T) {
   ...
   "partitions":[{"topic":"foo1","partition":2,"replicas":[1,2]},
	...
	_, err := GetPartitionListFromReader(bytes.NewBufferString(jsonStr), true, TopicNames{})
...
func TestWritingJSON(t *testing.T) {
   ...
   "partitions":[{"topic":"foo1","partition":2,"replicas":[1,2]},
	...
	pl, err := GetPartitionListFromReader(bytes.NewBufferString(jsonStr), true, TopicNames{})
...
func TestParsingText(t *testing.T) {
	...
	_, err := GetPartitionListFromReader(bytes.NewBufferString(textStr), false, TopicNames{})
